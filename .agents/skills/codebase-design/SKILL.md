...
description: Shared vocabulary and guidance for designing deep modules. Use when the user wants to design or improve a module's interface, decide where a seam goes, make code more testable or AI-navigable, or when another skill needs the deep-module vocabulary. For codebase-wide architectural-friction reviews and opportunity discovery (including exploring new seams), load this skill and read its IMPROVING.md companion workflow.
---
...
## Finding opportunities across a codebase

When the user wants to assess the codebase for architectural friction, identify deepening opportunities, or **explore new seams** as opportunities to improve the codebase, read [IMPROVING.md](IMPROVING.md) and follow its review workflow. When they already have a particular module or interface in mind, use this skill directly to work through its design.
